        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-center pt-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div ref={titleRef} className="text-center">
              <AnimatedTitle text="WorshipChordsAI" className="mb-3" />
              <div className="min-h-[2rem] flex items-center justify-center mt-2">
                ...
                >
                  AI-powered chord & beat detection for Christian Worship and Arabic Sunday services. Get your songs transcribed easily!
                </motion.p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 lg:text-left">
              ...
              >
                ...
                <p className="text-md text-gray-700 dark:text-gray-200 leading-relaxed">
                  WorshipChordsAI is a free platform designed to help you generate chords for your Christian worship songs and Arabic Sunday services. If you&apos;d like to support the project to keep the backend server running unconditionally, you can use the donation link. We really appreciate your support! <br />

          ...
          <NavbarItem key={item.href} className="hidden sm:flex" suppressHydrationWarning>
            {item.isScroll ? (
              <Button
                ...
                className={`font-medium text-sm transition-all duration-200 ${isActiveRoute(item.href)
          ...
          <NavbarMenuItem key={item.href} suppressHydrationWarning>
            {item.isScroll ? (
              <Button
                ...
                className={`w-full justify-start font-medium text-base transition-all duration-200 ${isActiveRoute(item.href)

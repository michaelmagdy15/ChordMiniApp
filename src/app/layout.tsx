...
export const metadata: Metadata = {
  ...
  title: {
    default: 'WorshipChordsAI - Chord Recognition and Beat Tracking with LLM',
    template: '%s | WorshipChordsAI'
  },
  ...
  openGraph: {
    ...
    siteName: 'WorshipChordsAI',
    title: 'WorshipChordsAI - Chord Recognition and Beat Tracking with LLM',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'WorshipChordsAI - Music Analysis Platform',
      },
    ],
  },
  twitter: {

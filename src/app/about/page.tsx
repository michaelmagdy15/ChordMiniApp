      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-6 text-gray-700 dark:text-white">
            <p>
              WorshipChordsAI is built upon the excellent work of many open-source projects and services.
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-gray-700 dark:text-white">
            ...
            <div className="space-y-2">
              ...
              <p><strong>GitHub:</strong> <a href="https://github.com/ptnghia-j/ChordMiniApp" className="text-blue-600 dark:text-blue-400 hover:underline">WorshipChordsAI Repository</a></p>
            </div>
          </div>
        </div>
